...
const ShowData = () => {
  ...
  return (
    <>
      ...
      {/* this is edite form */}
      {editMode && (
        <div className="absolute top-0 z-10  inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center">
          <div className="bg-white p-8 rounded w-[500px]">
            <h2 className="text-2xl font-bold mb-4 mt-4">Edit Data</h2>
