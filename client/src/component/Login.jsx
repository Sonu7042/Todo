...
const Login = () => {
    ...
    return (
        <div className=' flex items-center justify-center shadow-sm py-3'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-10 text-center border p-4 bg-white shadow-sm rounded-lg h-[400px] w-[350px] ' >
                ...
                <button type='submit ' className='bg-blue-500 p-2 text-white  rounded-lg font-medium hover:bg-blue-600'>Submit</button>
